...
public final class FindValueServiceGrpc {
  ...
  /**
   */
  public static final class FindValueServiceStub extends io.grpc.stub.AbstractAsyncStub<FindValueServiceStub> {
  ...
  /**
   */
  public static final class FindValueServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<FindValueServiceBlockingStub> {
  ...
  /**
   */
  public static final class FindValueServiceFutureStub extends io.grpc.stub.AbstractFutureStub<FindValueServiceFutureStub> {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    MethodHandlers(FindValueServiceImplBase serviceImpl, int methodId) {
